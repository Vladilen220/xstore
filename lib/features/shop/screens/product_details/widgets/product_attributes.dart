                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Obx(() {
                              print("Stock status in UI: ${controller.variationStockStatus.value}");
                              return Text(controller.variationStockStatus.value, style: Theme.of(context).textTheme.titleMedium,
                              );
                            }),
                          ],
                        ),
