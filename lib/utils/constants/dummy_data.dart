...
class TDummyData {
  ...
  productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      id: '1',
        ...
        description:
      'Flutter is Google mobile UI open source framework to build high-quality native (super fast) interfaces for iOS and Android apps with the unified ',
      attributeValues: {'Color': 'Orange', 'Size': 'EU 34'}), // Product VariationModel
      ProductVariationModel(
      id: '2', stock: 15, price: 35, image: TImages.productImage7, attributeValues: {'Color': 'Black', 'Size': 'EU 32'}), // ProductVariationModel
      ProductVariationModel(
      id: '3', stock: 14, price: 34, image: TImages.productImage9, attributeValues: {'Color': 'Brown', 'Size': 'EU 34'}), // ProductVariationModel
      ProductVariationModel(
      id: '4', stock: 13, price: 33, image: TImages.productImage7, attributeValues: {'Color': 'Black', 'Size': 'EU 34'}), // ProductVariationModel
      ProductVariationModel(
      id: '5', stock: 12, price: 32, image: TImages.productImage9, attributeValues: {'Color': 'Brown', 'Size': 'EU 32'}), // Product VariationModel
      ProductVariationModel(
      id: '6', stock: 11, price: 31, image: TImages.productImage8, attributeValues: {'Color': 'Orange', 'Size': 'EU 32'}), // Product VariationModel
    ],
        productType: 'ProductType.variable',
    ),
    ProductModel(
  ...
  static final List<CategoryModel> categories = [
    CategoryModel(id: '5', image: TImages.electronicsIcon, name: 'Electronics', parentId : '', isFeatured: true),
    CategoryModel(id: '3', image: TImages.clothIcon, name: 'Clothes', parentId : '', isFeatured: true),
    CategoryModel(id: '4', image: TImages.animalIcon, name: 'Animals',parentId : '', isFeatured: true),
    CategoryModel(id: '6', image: TImages.shoeIcon, name: 'Shoes',parentId : '', isFeatured: true),
    CategoryModel(id: '7', image: TImages.cosmeticsIcon, name: 'Cosmetics',parentId : '', isFeatured: true),
    CategoryModel(id: '14', image: TImages.jeweleryIcon, name: 'Jewelery',parentId : '', isFeatured: true),
    ///subcategories
